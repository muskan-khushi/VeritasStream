...
import { Upload, FileText, AlertOctagon, CheckCircle2, Zap, Shield, Activity, Lock } from 'lucide-react';
...
const GlassCard = ({ children, className = "", delay = 0 }) => (
  ...
  >
    {/* Subtle gradient overlay for 'frost' effect */}
  ...
  return (
    <div className="min-h-screen text-slate-200 selection:bg-cyan-500/30 font-sans">
      ...
      <div className="nebula-bg">
        <div className="orb w-[600px] h-[600px] bg-indigo-600/30 top-[-10%] left-[-10%]" />
        <div className="orb w-[500px] h-[500px] bg-fuchsia-600/20 bottom-[-10%] right-[-10%] animation-delay-2000" />
        <div className="orb w-[300px] h-[300px] bg-cyan-500/20 top-[40%] left-[40%]" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto p-6 lg:p-12">
        ...
        <header className="flex justify-between items-end mb-16">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-cyan-200/60 text-lg flex items-center gap-2 mt-2 font-light">
              <Shield size={18} />
              Forensic Intelligence Stream v1.0
            </p>
          </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            {/* Mini Stat Card */}
            <GlassCard className="p-6 flex items-center justify-between" delay={0.4}>
               <div>
                  <p className="text-white/30 text-[10px] uppercase tracking-widest mb-1">Total Logs Processed</p>
                          ...
                          <div className="flex items-center gap-5">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-white/40 font-mono mt-1">
                                <span className="text-white/20">ID:</span> {report.case_id} <span className="mx-2">|</span> <span className="text-white/20">SIZE:</span> {report.total_lines} Lines
                              </p>
                            </div>
                          </div>

                          <div className="text-right">
                             <div className={`text-2xl font-bold ${report.anomalies_found > 0 ? 'text-red-400 drop-shadow-[0_0_8px_rgba(239,68,68,0.5)]' : 'text-emerald-400 drop-shadow-[0_0_8px_rgba(16,185,129,0.5)]'}`}>
                                {report.anomalies_found}
                             </div>
                             <div className="text-[9px] text-white/30 uppercase tracking-widest mt-1">Anomalies Detected</div>
                          </div>
                        </div>
                      </motion.div>
                    ))
